...
function CardItemDetail() {
  ...
  const description = item.product_description.split(',').reduce((acc, item) => {
  ...
  return (
    <div className="px-32 gap-10 grid grid-rows-1 grid-flow-col">
      <div className="row-span-2">
        <img src={item.product_image_1} alt={item.product_name} className="w-[100%]" />
      </div>
      ...
      <div className="col-span-1">
        ...
        <div className='flex flex-col gap-2 text-md'>
          ...
          <p className='flex gap-5'>
            ...
            <span>:</span>
            <span>Rp {item.product_price.toLocaleString('id-ID', { minimumFractionDigits: 0 })}</span>
          </p>
          <p className='flex gap-5'>
