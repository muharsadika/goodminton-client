...
function ProfileContainer() {
  ...
  const { formValues, handleChange, updateProfile } = useProfileUpdate()
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-row justify-center border rounded-2xl my-auto p-20 bg-gray-50">
      ...
      <div className="grid grid-cols-2 gap-5 items-center">
        ...
        <input name="fullname" value={formValues.fullname} onChange={handleChange} className="border border-gray-300 rounded p-1" type="text" placeholder={profile.fullname} />
        <label className="text-right mr-5">Username :</label>
        <input name="username" value={formValues.username} onChange={handleChange} className="border border-gray-300 rounded p-1" type="text" placeholder={profile.username} />
        <label className="text-right mr-5">Email :</label>
        <input name="email" value={formValues.email} onChange={handleChange} className="border border-gray-300 rounded p-1" type="text" placeholder={profile.email} />
        <label className="text-right mr-5">Phone :</label>
        <input name="phone" value={formValues.phone} onChange={handleChange} className="border border-gray-300 rounded p-1" type="text" placeholder={profile.phone} />
